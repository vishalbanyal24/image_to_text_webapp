"""
Django settings for image_to_text_project project.
...
ROOT_URLCONF = 'image_to_text_project.urls'
...
WSGI_APPLICATION = 'image_to_text_project.wsgi.application'
